...
const LandingPage = (props) => {
    ...
    const fetchSnips = async(userName) =>{
        ...
        fetch(`https://snippet-hub-back.onrender.com/api/${userName}/home`,{
          method: 'GET'
        }).then(res => res.json())
          .then(data => {
    ...
    try{
        e.preventDefault();
        fetch(`https://snippet-hub-back.onrender.com/api/users/${userName}/${pass}`,{
            method:'GET',
    ...
    const handleDelete = async (id) => {
        ...
        try {
          const res = await fetch(`https://snippet-hub-back.onrender.com/api/${id}`, {
            method: 'DELETE'
          });
      ...
      const handleGroupDelete = async (e) => {
        ...
        try {
          ...
          const res = await fetch(`https://snippet-hub-back.onrender.com/api/${u}/${g}`, {
            method: 'DELETE'
          });
    ...
    const applySave = (id,e) => {
        ...
        try{
        fetch(`hhttps://snippet-hub-back.onrender.com/api/${id}`,
            {method:'PUT',
            headers:{
                'Content-Type':'application/json'
            },
    ...
    const downSnips = async(id,fileName) => {
        const response = await fetch(`https://snippet-hub-back.onrender.com/api/download/${id}`);
    ...
    const newUserCreate = async (newUser,newPass,newEmail) => {
        try {
            const response = await fetch('https://snippet-hub-back.onrender.com/api/signup', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    const snipCreate = async (title, group, language) => {
        setloading(true);
        try {
          const rep = await fetch(`https://snippet-hub-back.onrender.com/api/new/${userName}`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json'
            },
